...
public class TestGenericInformation {
    ...
    public void test(String engineName) throws Exception {
        ...
        org.junit.Assert.assertEquals("The result should contain the returned generic information value",
                                      "value",
                                      res.getResult());
    }
}
